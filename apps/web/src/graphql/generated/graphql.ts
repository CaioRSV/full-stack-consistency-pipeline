...
export type GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, name: string, email: string, website?: string | null, bio?: string | null, createdAt: string, balance: number, tier: UserTier, totalSent: number, transactions: Array<{ __typename?: 'Transaction', id: string, amount: number, fee: number, type: TransactionType, createdAt: string, sender?: { __typename?: 'User', id: string, name: string } | null, receiver: { __typename?: 'User', id: string, name: string } }> } | null };
...
export type CreateUserMutation = { __typename?: 'Mutation', createUser: { __typename?: 'User', id: string, name: string, email: string, website?: string | null, bio?: string | null, createdAt: string, balance: number, tier: UserTier } };

export type GetUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, name: string, email: string, website?: string | null, bio?: string | null, createdAt: string, balance: number, tier: UserTier, totalSent: number }> };
