...
const TIER_CONFIGS = [
  {
    ...
    feePercentage: feePercentagesDict[UserTier.Bronze],
    minSentVolume: 0.0,
    upgradeReward: 0.0,
  },
  {
    ...
    feePercentage: feePercentagesDict[UserTier.Silver],
    minSentVolume: 100.0,
    upgradeReward: 10.0,
  },
  {
    ...
    feePercentage: feePercentagesDict[UserTier.Gold],
    minSentVolume: 500.0,
    upgradeReward: 50.0,
  },
  {
    ...
    feePercentage: feePercentagesDict[UserTier.Platinum],
